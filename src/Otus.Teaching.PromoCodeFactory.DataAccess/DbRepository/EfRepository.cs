...
public sealed class EfRepository<TModelType, TKeyType> : IRepository<TModelType, TKeyType> where TModelType : DbEntity<TKeyType>
{
    public EfRepository(DataContext dataDbContext)
    {
